  ...
  return (
    ...
    >
      {onToggleFavorite && isFavorite && (
        <Button
          isIconOnly
          className="absolute top-2 left-2 z-10 bg-zinc-900/60 backdrop-blur-md border border-white/10 hover:border-violet-500/50"
          radius="full"
          size="sm"
          variant="flat"
          onPress={() => onToggleFavorite(match.id, match.type)}
        >
      ...
      <CardFooter className="flex flex-col gap-2 pt-0 px-4 pb-4">
