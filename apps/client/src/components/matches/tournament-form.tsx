            ...
            <Card className="shadow-medium border-purple-300/40 bg-purple-300/10">
                ...
                <CardBody className="grid grid-cols-1 md:grid-cols-4 gap-6 p-6">
                    ...
                    <div className="md:col-span-2">
                        {!user?.club_id ? (
                            <div className="p-5 bg-purple-300/20 border-2 border-purple-400/50 rounded-2xl flex flex-col gap-5 shadow-sm">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <div className="text-[12px] md:text-[14px] text-purple-200 space-y-2 font-bold leading-snug">
                                            ...
                                            <p className="border-t border-purple-400/50 pt-2 text-white">{t('matchForm.link_club.warning_search')}</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="flex flex-col sm:flex-row gap-3 items-center w-full justify-start">
                                    <Input
                                        ...
                                        classNames={{
                                            inputWrapper: "bg-white border-purple-400/50 shadow-inner h-10 font-bold"
                                        }}
                                    />
