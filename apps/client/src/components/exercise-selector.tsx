...
export default function ExerciseSelector({
  ...
  const themes = [
    ...
    ...Object.values(Theme).map((t_val) => ({
      key: t_val,
      label: t(`enums.theme.${t_val}`),
    })),
  ];
        ...
        {(onClose) => (
          <>
                        ...
                        <CardBody className="flex flex-row justify-between items-center p-3">
                          <div className="flex flex-col">
                            ...
                            <div className="flex gap-2 text-tiny text-default-500">
                              ...
                              {exercise.themes.map((t_val) => (
                                <Chip key={t_val} size="sm" variant="dot">
                                  {t(`enums.theme.${t_val}`)}
                                </Chip>
                              ))}
                            </div>
            ...
            <ModalFooter>
              ...
              <Button
                color="primary"
                isDisabled={selectedExercises.size === 0}
