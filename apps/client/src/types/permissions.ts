...
/*
Attention this file is hardcopied here from apps/cloudflare-worker/src/types/permissions.ts, any change here should be made in the original file and then copied here.
*/
