    ...
    <DefaultLayout maxWidth="max-w-full">
      <section className="flex flex-col gap-5 w-full px-4">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-cyan-500/10 via-blue-500/5 to-cyan-500/10 border border-cyan-500/20">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,var(--tw-gradient-stops))] from-cyan-500/10 via-transparent to-transparent" />
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,var(--tw-gradient-stops))] from-blue-500/5 via-transparent to-transparent" />
            ...
            <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 mt-2 w-full max-w-4xl mx-auto px-4">
              ...
              <Link
                className={buttonStyles({
                  ...
                  size: "lg",
                  className:
                    "w-full sm:w-auto font-bold px-8 border-violet-500/50 text-violet-200",
                })}
              ...
              <Link
                className={buttonStyles({
                  ...
                  size: "lg",
                  className:
                    "w-full sm:w-auto font-bold px-8 bg-purple-300 text-purple-950",
                })}
            ...
            <p className="text-sm text-default-500 leading-relaxed">
              <Trans
                components={[
                  ...
                  <a
                    className="text-primary font-semibold underline hover:text-primary-400 transition-colors"
                    href="https://www.iut-bethune.univ-artois.fr/formations/but-reseaux-et-telecommunications/"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card className="border border-default-200 bg-content1 overflow-hidden group hover:shadow-lg hover:shadow-primary/5 transition-all">
            ...
            <CardBody className="relative p-5 flex flex-col items-center text-center gap-3">
              ...
              <p className="text-xs text-default-500">
                Collez un lien vidéo et notre IA génère des exercices détaillés
                avec synopsis, thèmes et catégorie d'âge.
              </p>
            </CardBody>
          </Card>
          ...
          <Card className="border border-default-200 bg-content1 overflow-hidden group hover:shadow-lg hover:shadow-red-500/5 transition-all">
            ...
            <CardBody className="relative p-5 flex flex-col items-center text-center gap-3">
              ...
              <p className="text-xs text-default-500">
                Publiez ou recherchez des matchs amicaux. Filtrez par catégorie,
                niveau, distance et format.
              </p>
            </CardBody>
          </Card>
          ...
          <Card className="border border-default-200 bg-content1 overflow-hidden group hover:shadow-lg hover:shadow-red-500/5 transition-all">
            ...
            <CardBody className="relative p-5 flex flex-col items-center text-center gap-3">
              ...
              <p className="text-xs text-default-500">
                Organisez ou recherchez des tournois de football amateur. Idéal
                pour dynamiser votre saison.
              </p>
            </CardBody>
          </Card>
          ...
          <Card className="border border-default-200 bg-content1 overflow-hidden group hover:shadow-lg hover:shadow-green-500/5 transition-all">
            ...
            <CardBody className="relative p-5 flex flex-col items-center text-center gap-3">
              ...
              <p className="text-xs text-default-500">
                Organisez vos séances et planifiez votre calendrier sportif.
                Tout centralisé.
              </p>
            </CardBody>
          </Card>
