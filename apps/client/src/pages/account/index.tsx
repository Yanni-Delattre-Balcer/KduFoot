      ...
      <div className="container mx-auto max-w-5xl p-4 md:p-8 space-y-8 animate-appearance-in pb-24">
        <div className="flex flex-col gap-2">
          <h1 className="text-4xl font-black text-white tracking-tighter">
            {t("nav.userPrefix", "Mon")}{" "}
            <span className="text-primary">Compte</span>
          </h1>
          <p className="text-default-500 font-medium">
            Gérez vos informations personnelles et les détails de votre club
            certifié.
          </p>
          {hasMultipleClubs && (
            <div className="mt-4 p-4 bg-warning-50/10 border border-warning-500/30 rounded-xl flex items-start gap-3 animate-appearance-in shadow-lg shadow-warning-500/5">
              <span className="text-warning-500 text-xl font-black flex-shrink-0 animate-pulse">
                💡
              </span>
              <p className="text-sm font-semibold text-warning-200 leading-relaxed">
                Vous gérez actuellement plusieurs clubs. Pour toute modification
                sur votre club principal, veuillez contacter le support.
              </p>
            </div>
          )}
        </div>
