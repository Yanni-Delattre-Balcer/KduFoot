    ...
    try {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_API_URL}/api/admin/users/${encodeURIComponent(selectedUserId)}/sirets`,
        {
          ...
          body: JSON.stringify({ siret: newSiret, force: forceSiret }),
        },
      );
    ...
    <div className="container mx-auto py-8 px-4 max-w-7xl animate-in fade-in duration-700">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          >
            {isUpToDate === false ? "⚠️ Sync Scopes Required" : "✓ Sync Scopes"}
          </Button>
          <Button
            className="font-black tracking-widest uppercase text-xs"
            color="secondary"
      ...
      <div className="mb-8">
        <Tabs
          ...
          classNames={{
            ...
            tabContent: "group-data-[selected=true]:text-primary-500 font-bold",
          }}
          color="primary"
