  ...
  const handleAnalyze = () => {
    ...
    if (isLocked) {
      ...
      window.location.href =
        "/account?from=" + encodeURIComponent(window.location.pathname);
      ...
      <section className="flex flex-col gap-10 w-full px-4">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-amber-600/15 via-yellow-500/10 to-orange-500/10 border border-amber-500/20">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "repeating-linear-gradient(90deg, transparent, transparent 40px, rgba(245,158,11,0.3) 40px, rgba(245,158,11,0.3) 80px)",
            }}
          />
          ...
          <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center max-w-7xl gap-4">
            <div className="flex items-center gap-4 w-full sm:w-auto">
              ...
              <div className="flex flex-col">
                <p className="font-bold text-base sm:text-large">
                  {selectedExercises.length}{" "}
                  {t("exercises.selected", "exercice(s)")}
                </p>
                <p className="text-tiny text-default-500">
                  {selectedExercises.length * 15} min (est.)
                </p>
              </div>
            </div>
            <Button
              as={Link}
              className="font-bold shadow-lg shadow-amber-500/30 w-full sm:w-auto text-white"
              color="warning"
              size="lg"
              to="/training"
            >
