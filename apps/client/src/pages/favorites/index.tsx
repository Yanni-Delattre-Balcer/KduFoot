                ...
                <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-cyan-600/15 via-sky-500/10 to-blue-500/10 border border-cyan-500/20">
                    ...
                    <div className="relative flex flex-col items-center gap-6 py-14 px-6 text-center">
                        <div className="flex flex-col items-center gap-4">
                            ...
                            <h1 className="text-3xl lg:text-4xl font-bold bg-clip-text text-transparent bg-linear-to-r from-cyan-500 to-blue-500 uppercase tracking-tighter">
                                {t("nav.favorites")}
                            </h1>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-3 p-1 rounded-2xl bg-default-100/50 backdrop-blur-sm w-full sm:w-auto">
                            {showVideoAnalysis && (
                                <Button
                                    ...
                                    size="lg"
                                    className={view === 'exercises' ? "font-bold text-white bg-linear-to-r from-[#17c964] to-[#12a150] w-full sm:w-auto" : "w-full sm:w-auto"}
                                    startContent={
                            ...
                            <Button
                                ...
                                size="lg"
                                className={view === 'matches' ? "font-bold text-white bg-linear-to-r from-violet-500 to-purple-500 w-full sm:w-auto" : "w-full sm:w-auto"}
                                startContent={
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                            ...
                            <Button
                                ...
                                size="lg"
                                className={view === 'tournaments' ? "font-bold text-purple-900 shadow-lg shadow-purple-500/20 bg-purple-400 w-full sm:w-auto" : "w-full sm:w-auto"}
                                startContent={
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                            ...
                            <>
                                {loadingEx ? (
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {favExercises.map(ex => (
                                            <Card key={ex.id} className="group hover:shadow-lg hover:shadow-cyan-500/10 transition-all bg-[#251820] border border-cyan-500/20 hover:border-cyan-500/40">
                                ...
                                {loadingMatches ? (
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                        {favMatches.map(match => (
                                            <Card key={match.id} className="group hover:shadow-lg hover:shadow-violet-500/10 transition-all bg-[#252018] border border-violet-500/20 hover:border-violet-500/40">
                                                <CardBody>
                                ...
                                {loadingMatches ? (
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                        {favTournaments.map(match => (
                                            <Card key={match.id} className="group hover:shadow-lg hover:shadow-purple-500/10 transition-all bg-[#252318] border border-purple-500/20 hover:border-purple-500/40">
                                                <CardBody>
                                                    <Link to={`/matches/${match.id}`} className="block">
                                                    <div className="flex justify-between items-start mb-2">
