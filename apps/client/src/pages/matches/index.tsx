            ...
            <section className="flex flex-col gap-6 w-full px-4">
                ...
                {isUserLoading ? (
                    ...
                    <DataWall
                        ...
                        message={isLocked ? "Les informations de votre compte ne sont pas remplies. Vous n'avez pas accès à ces informations tant que votre fiche MON COMPTE n'est pas 100% completée." : undefined}
                    />
                ) : (
                    <div id="results-container" className="flex flex-col gap-6 animate-appearance-in">
                        {view === 'create' ? (
                            type === 'match' ? (
