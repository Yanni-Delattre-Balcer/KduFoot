                ...
                <Card className="lg:col-span-2 shadow-medium border border-default-100 bg-[#18181b]">
                    ...
                    <CardBody className="p-6 gap-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            >
                                <span className="ml-2">{match.category}</span>
                            </Chip>
                            <Chip
                            ...
                            >
                                <span className="ml-2">{match.level || 'Niveau NC'}</span>
                            </Chip>
                            <Chip
                            ...
                            >
                                <span className="ml-2">{match.format}</span>
                            </Chip>
                            <Chip
                            ...
                            >
                                <span className="ml-2">{match.pitch_type || 'Terrain NC'}</span>
                            </Chip>
                            <Chip
                    ...
                    <Card className="bg-[#18181b] shadow-medium border border-default-100/20">
                        ...
                        <CardBody className="flex flex-col items-center gap-4 py-8">
                            {match.club?.logo_url ? (
                                ...
                                <div className="w-24 h-24 bg-gradient-to-br from-orange-400 to-red-500 rounded-full flex items-center justify-center shadow-lg text-white">
                ...
                <div className="lg:col-span-3 mt-8">
                    <div className="flex items-center gap-3 mb-4">
                        <h2 className="text-2xl font-bold flex items-center gap-2 text-white">
                            <span className="p-2 bg-gradient-to-r from-orange-500 to-amber-500 rounded-lg text-white">
